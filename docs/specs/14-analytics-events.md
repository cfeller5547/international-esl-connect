...
8. `curriculum_roadmap_viewed`
   - trigger: Learn roadmap route rendered
   - properties: `level`, `current_unit_slug`, `total_units`
9. `curriculum_roadmap_unit_clicked`
   - trigger: user taps a current or completed unit from the Learn roadmap
   - properties: `level`, `unit_slug`, `unit_status`, `click_target`
10. `unit_started`
   - trigger: curriculum unit overview opened
   - properties: `unit_slug`
11. `unit_activity_completed`
